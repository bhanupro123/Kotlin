...
fun FaceAnalytics(image: ProcessedImage, modifier: Modifier = Modifier) = Column(
    ...
    if (image.name.isNotEmpty()) Text(text = image.name, style = MaterialTheme.typography.titleLarge)
    Text(text = "Role: "+image.role, style = MaterialTheme.typography.titleMedium)
