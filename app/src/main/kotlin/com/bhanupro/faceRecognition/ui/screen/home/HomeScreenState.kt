...
import com.bhanupro.faceRecognition.R
import com.bhanupro.faceRecognition.ui.navigation.Routes
import com.bhanupro.faceRecognition.ui.screen.permission.Permission
import com.bhanupro.faceRecognition.ui.screen.permission.PermissionProvider
...
data class HomeScreenState(
    ...
    companion object {
        ...
        val defaultBottomBarItem: NavBarItem = NavBarItem(Routes.Faces, R.drawable.ic_faces)
        val defaultBottomBarItems: List<NavBarItem> = listOf(
            defaultBottomBarItem,
            NavBarItem(Routes.AddFace, R.drawable.ic_add_face),
         NavBarItem(Routes.Recognise, R.drawable.ic_home)
