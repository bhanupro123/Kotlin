...
import com.bhanupro.faceRecognition.ui.navigation.HomeHost
...
import com.bhanupro.faceRecognition.ui.screen.home.HomeScreenState.Companion.defaultBottomBarItem
...
fun HomeScreen(appState: AppState, vm: HomeViewModel = hiltViewModel()) {
    ...
    Scaffold(
        ...
        bottomBar = { BottomBar(state.bottomBarItem,
            state.bottomBarItems, onClick = vm::navigate
        ) },
