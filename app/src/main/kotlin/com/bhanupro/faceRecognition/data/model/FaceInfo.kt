...
import com.bhanupro.faceRecognition.app.Utils
import com.bhanupro.faceRecognition.lib.FileUtils.readBitmap
...
data class FaceInfo(
    ...
    fun processedImage(context: Context): ProcessedImage {
        ...
        return ProcessedImage(role=role, id = id, name = name, image = image, frame = frame, faceBitmap = face, landmarks = landmarks)
    }
